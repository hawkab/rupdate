            ...
            try
            {
                ...
                if (resp.IsOK)
                {
                    ...
                    try
                    {
                        ...
                        sourcePage = req.Get("http://29.ru/job/my/resume/").ToString();
                        raw = sourcePage.Substrings("<tr valign=\"top\" id=\"row", "\"\tclass=", 0);
                        ...
                        for (int i = 0; i < raw.Count(); i++)
                        {
                            ...
                            try
                            {
                                ...
                                sourcePage = req.Post("http://29.ru/job/my/resume/", reqParams).ToString();
                        ...
                        Console.WriteLine(DateTime.Now.ToString("hh:mm:ss") + " 29-" + login + " done.");
                    }
